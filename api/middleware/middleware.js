const Actions = require('../actions/actions-model'); //eslint-disable-line
const Projects = require('../projects/projects-model'); //eslint-disable-line
...
function validateProject(req, res, next) {
    ...
    if (!name || !name.trim() || !description || !description.trim()) { //eslint-disable-line
